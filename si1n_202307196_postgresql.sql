...
COMMENT ON COLUMN estoques.loja_id IS 'Identificador único para cada registro na tabela. É usado para referenciar de forma exclusiva cada entrada e facilitar a recuperação de dados específicos.
